...
# Personal repository for Simulating a PCB with openEMS.
...
```eye_diagram.py``` is provided for generating eye diagrams but its currently WIP.

## Gallery:

![s_param](docs/s_param_4,3_3,3.png)
